...
fun WhisperMainLayout() {
    ...
    WhisperTheme(darkTheme = isDarkTheme) {
        Surface(
            ...
            when {
                showGithubLogin -> GitHubLoginScreen(onBack = { showGithubLogin = false })
                showSettings -> SettingsScreen(
                    ...
                    onGithubLoginClick = { showGithubLogin = true }
                )
            }
        }
    }
        ...
        TopAppBar(
            ...
            actions = {
                Row(
                    ...
                    IconButton(onClick = onGithubLoginClick) {
                        Icon(
                ...
                ElevatedCard(
                    ...
                    Column(modifier = Modifier.padding(8.dp)) {
                        Row(
                            ...
                            IconButton(onClick = { onChatVisibilityChange(false) }) {
                                Icon(
                                    Icons.Default.Close,
